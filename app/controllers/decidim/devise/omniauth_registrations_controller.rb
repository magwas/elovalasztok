  ...
  module Devise
    ...
    class OmniauthRegistrationsController < ::Devise::OmniauthCallbacksController
      ...
      def create
		...
		if (nil == user.officialized_at) and (nil!= form_params[:officialized_at])
		    user.officialized_at = form_params[:officialized_at]
		    user.officialized_as = form_params[:officialized_as]
		    user.save!
		end
      ...
      def user_params_from_oauth_hash
        return nil if oauth_data.empty?
        {
          ...
          officialized_at: oauth_data[:info][:officialized_at],
          officialized_as: oauth_data[:info][:officialized_as],
          raw_data: oauth_hash
        }
      end
