...
require 'omniauth/ada/signed_request'
require 'openssl'
require 'rack/utils'
require 'uri'
  ...
  module Strategies
    class Ada < OmniAuth::Strategies::OAuth2
      ...
      option :client_options, {
        site: 'https://graph.ada.com/v2.10',
        authorize_url: "https://www.ada.com/v2.10/dialog/oauth",
      ...
      rescue OmniAuth::Ada::SignedRequest::UnknownSignatureAlgorithmError => e
      ...
      #      https://github.com/ada/ada-php-sdk/blob/master/src/base_ada.php#L477
      def callback_url
      ...
      #
      # For example: /auth/ada?display=popup
      ...
      def signed_request_from_cookie
        @signed_request_from_cookie ||= raw_signed_request_from_cookie && OmniAuth::Ada::SignedRequest.parse(raw_signed_request_from_cookie, client.secret)
      end
